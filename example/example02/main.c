...
static void *v4l2_streaming(void *arg) 
{
  ...
  //create a window
  sdlScreen = SDL_CreateWindow("live", SDL_WINDOWPOS_UNDEFINED,
...
int main(int argc, char const *argv[]) 
{
  ...
  int video_fildes = v4l2_open(FILE_VIDEO);
  if (video_fildes == -1) 
  {
  ...
  if (v4l2_querycap(video_fildes, FILE_VIDEO) == -1) 
  {
